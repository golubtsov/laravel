...
function CreateBook() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8000/api/books/create', book, {
            method: 'POST'
        })
    ...
    return (
        <>
            ...
            <form ref={form}>
                <p>Автор</p>
                <p><input type="text" name='author_id' defaultValue={4} /></p>
                <p>Название</p>
                <p><input type="text" name='title' /></p>
                <p>Описание</p>
                <p><input type="text" name='description' defaultValue={"description-1"} /></p>
